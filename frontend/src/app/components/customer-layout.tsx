...
import { User, FileText, PlusCircle, LogOut, Menu } from "lucide-react";
...
export default function CustomerLayout({ children }: CustomerLayoutProps) {
  ...
  const navItems = [
    { to: "/customer/profile", icon: User, label: "Hồ sơ của tôi" },
    { to: "/customer/create-loan", icon: PlusCircle, label: "Tạo yêu cầu vay" },
    { to: "/customer/loans", icon: FileText, label: "Danh sách yêu cầu vay" },
  ];
